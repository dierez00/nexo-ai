...
from nexo_api.api.deps import enforce_rate_limit_public, get_user_or_public
...
@router.get(
    ...
    summary="Disponibilidad de citas (acceso público)",
...
@router.post(
    ...
    summary="Crear hold de cita (acceso público; 409 si solapa)",
